        ...
        A = function() {
            function t() {
                ...
                d()(this, t), window.addEventListener("message", function(t) {
                    var n = t.data.event;
                    void 0 !== n && "function" == typeof e["on" + n] ? e["on" + n](t.data) : void 0 !== t.data.show && (void 0 !== t.data.time && (window.gametime = t.data.time), w.a.commit("SET_PHONE_VISIBILITY", t.data.show))
